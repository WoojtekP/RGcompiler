...
if "all" in games:
  ...
  # games.append('breakthrough_split.rbg')
  ...
  #games.append('connect6.rbg')
  #games.append('chess_200.rbg')
  #games.append('breakthru.rbg')
  #games.append('breakthru_split.rbg')
  #games.append('canadianDraughts.rbg')
  #games.append('chineseCheckers6.rbg')
