...
class cfg:
  ...
  DEFAULT_RG2CPP_OPTIONS = '--opt-conditions 3 --simple-path-compression 1 --no-cycle-detection 0 --print-function-names 0 --show-orginal-node-names 0 --verification 0'
