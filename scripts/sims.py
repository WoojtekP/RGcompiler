...
if "all" in games:
  ...
  games.append('surakarta.hrg')
  games.append('theMillGame.hrg')
  games.append('theMillGame_lud.hrg')
  games.append('ticTacDie.hrg')
  #games.append('twentyOne.hrg')
  games.append('ultimateTicTacToe.hrg')
  games.append('yavalath.hrg')
